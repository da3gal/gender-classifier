...
app = FastAPI()
app.mount("/assets", StaticFiles(directory="web/templates/assets"), name="assets")
app.mount("/css", StaticFiles(directory="web/templates/css"), name="css")
app.mount("/js", StaticFiles(directory="web/templates/js"), name="js")
